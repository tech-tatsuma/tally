...
from app.models.entities import Account, AccountType, Category, CategoryType, User, UserRole
...
async def session():
    ...
    async with maker() as s:
        s.add(User(id=USER_ID, name="Test", email="test@example.com", password_hash=hash_password("TestPassword123"), role=UserRole.admin)); await s.flush()
